...
class Matrix
  ...
  autoload :EigenvalueDecomposition, "shared/matrix/eigenvalue_decomposition"
  autoload :LUPDecomposition, "shared/matrix/lup_decomposition"
